...
#define WEBKIT_TYPE_WEB_EXTENSION_MATCH_PATTERN_ERROR webkit_web_extension_match_pattern_error_get_type ()

WEBKIT_API GType
webkit_web_extension_match_pattern_error_get_type (void);
...
#define WEBKIT_TYPE_FEATURE_STATUS webkit_feature_status_get_type ()

WEBKIT_API GType
webkit_feature_status_get_type (void);
...
/* Enumerations from WebKitXRPermissionRequest.h. */
#define WEBKIT_TYPE_XR_SESSION_MODE webkit_xr_session_mode_get_type ()

WEBKIT_API GType
webkit_xr_session_mode_get_type (void);
#define WEBKIT_TYPE_XR_SESSION_FEATURES webkit_xr_session_features_get_type ()

WEBKIT_API GType
webkit_xr_session_features_get_type (void);
G_END_DECLS
