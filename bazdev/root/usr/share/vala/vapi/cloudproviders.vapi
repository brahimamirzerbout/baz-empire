...
[CCode (cprefix = "CloudProviders", gir_namespace = "CloudProviders", gir_version = "0.3", lower_case_cprefix = "cloud_providers_")]
namespace CloudProviders {
	...
	public class ProviderExporter : GLib.Object {
		[CCode (has_construct_function = false)]
		public ProviderExporter (GLib.DBusConnection bus, string bus_name, string bus_path);
		public unowned string get_name ();
