...
It's clever because it simultaneously validates
(people are searching) and
(you reach them via organic search).
The result is hundreds of tools and templates in cute little subfolders.
How does this work practically?
Well, you start by making a list of everything customers might search for. Then you're looking for a combination of
low keyword difficulty and cost.
(you reach them via organic search).
That's the most valuable thing to make.
Thanks to the one and only
, Veed's CEO, for this example.
