...
I hear you cry. Well, I disagree. Here's an example, from a recruitment company, showing how just a couple of minutes of googling can
...
Simple personal references can make a huge difference. The
title will dramatically improve
. And the p.s. is a nice human touch, which should improve the response rate.
The funny thing is that the bar is so low with cold emails, that a
is more than enough to stand out.
Now, if you're stuck writing a template email, you won't be able to personalise easily (unless your
